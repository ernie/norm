  ...
  class Record
    describe Delegator do
      ...
      let(:delegator_class) {
        ...
        Class.new { include Norm::Record::Delegator(record_class) }
      }
      ...
      describe 'generated module' do
        ...
        it 'includes Norm::Record::Delegator into base' do
          subject.ancestors.must_include Norm::Record::Delegator
        end
      ...
      describe '.with_identifiers' do
        ...
        it 'creates a new delegator with the identity provided in arguments' do
          ...
          delegator.must_be_kind_of Norm::Record::Delegator
          delegator.name.must_equal 'Ernie'
